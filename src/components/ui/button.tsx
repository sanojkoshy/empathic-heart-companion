  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        aurora: "bg-gradient-aurora text-primary-foreground hover:bg-gradient-sunset shadow-glow hover:shadow-embrace border-0",
        healing: "bg-gradient-healing text-healing-foreground hover:bg-gradient-ocean shadow-soft hover:shadow-glow border-0",
        comfort: "bg-gradient-sunset text-secondary-foreground hover:bg-gradient-aurora shadow-embrace hover:shadow-glow border-0",
      },
      size: {
